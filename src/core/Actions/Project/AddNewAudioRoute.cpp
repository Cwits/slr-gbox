...
AddNewRouteAction::AddNewRouteAction(const ActionBase *base) :
    _action( *(static_cast<const Actions::AddNewAudioRoute*>(base)) )
{
}

AddNewRouteAction::~AddNewRouteAction() {

}

void AddNewRouteAction::exec(ControlContext &ctx) {
...
std::unique_ptr<ActionExecutable> createAddNewRouteAction(const ActionBase *base) {
    return std::make_unique<AddNewRouteAction>(base);
}
